...
public class OnlieRecordsActivity extends AppCompatActivity {
    private static final String TAG = "RecordsActivity";
    private int difficulty = 0;
    private int score = 0;
    RecordsDaoIntDBImpl recordsDaoDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordsDaoDB = new RecordsDaoIntDBImpl(OnlieRecordsActivity.this);
        ...
        return_btn.setOnClickListener(view -> {
            Intent intent = new Intent(OnlieRecordsActivity.this, MainActivity.class);
    ...
    public void deleteRecords() {
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                AlertDialog.Builder builder = new AlertDialog.Builder(OnlieRecordsActivity.this);
